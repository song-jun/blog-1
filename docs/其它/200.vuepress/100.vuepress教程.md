...
::: tip
有 2 种方案<br>
分别为 [vuepress-plugin-auto-sidebar](https://shanyuhai123.github.io/vuepress-plugin-auto-sidebar/) 和 [vuepress-bar](https://github.com/ozum/vuepress-bar)<br>
vuepress-plugin-auto-sidebar 方案的缺点为不支持侧边栏嵌套, 不支持多个侧边栏, 会自动生成默认分组, 自动生成的默认分组时直接上级目录名称,体验不好
:::
